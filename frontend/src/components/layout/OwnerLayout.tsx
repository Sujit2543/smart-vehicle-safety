...
import {
  LayoutDashboard, Car, FileText, Wrench, Bell,
  User, LogOut, Shield, Menu, X, AlertTriangle
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/expiry',             icon: Shield,          label: 'Expiry Tracker' },
  { to: '/breakdown-history',  icon: AlertTriangle,   label: 'Breakdown' },
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-gray-100 flex-shrink-0">
          <Link to="/dashboard" className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="text-gray-400 text-xs leading-tight">Safety Tag</div>
            </div>
          </Link>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="lg:hidden flex-shrink-0 bg-white border-b border-gray-200 px-4 h-14 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900 text-sm">Car Deal Safety</span>
          </div>
        </header>
